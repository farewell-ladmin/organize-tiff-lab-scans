...
```
/path/to/scans/film_roll_001/
```

- **Edits** → `/path/to/scans/film_roll_001/Edits/`
- **Not TIFF** → `/path/to/scans/film_roll_001/Not TIFF/`
- **Non Film Scanner** (ALL DSLR folder) → `/path/to/scans/Non Film Scanner/film_roll_001/`
- **Non Film Scanner** (MIXED folder) → `/path/to/scans/film_roll_001/Non Film Scanner/`
